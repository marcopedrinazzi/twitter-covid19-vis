...
for element in data:
    ...
    trigram_tokens=list(nltk.trigrams(data[index]['full_text'].split()))
    clean_trigram_tokens = [gram for gram in trigram_tokens if not any(stop in gram for stop in stopwords)]
